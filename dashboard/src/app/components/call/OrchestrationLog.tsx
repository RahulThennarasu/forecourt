...
// Step and SubSteps are hoisted to module scope so their function identity is
// stable across parent re-renders. If they were defined inside OrchestrationLog,
// each WebSocket event would replace the function reference, React's reconciler
// would treat every entry as a new component type, and every existing row
// would unmount + remount — replaying its motion fade-in. That was the flicker.
function Step({
  label,
  title,
  meta,
